...
public class DaftarTransaksi extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        getContentPane().add(jLabel6, new org.netbeans.lib.awtextra.AbsoluteConstraints(590, 150, 160, 40));
        ...
        getContentPane().add(tCari, new org.netbeans.lib.awtextra.AbsoluteConstraints(790, 150, 340, 40));

        cbperiode.setFont(new java.awt.Font("Tahoma", 1, 14)); // NOI18N
        cbperiode.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "Tahun Ajaran" }));
        cbperiode.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                cbperiodeActionPerformed(evt);
            }
        });
        getContentPane().add(cbperiode, new org.netbeans.lib.awtextra.AbsoluteConstraints(1140, 150, 210, 40));
        ...
        getContentPane().add(jScrollPane2, new org.netbeans.lib.awtextra.AbsoluteConstraints(1030, 20, 330, 120));
    ...
    private void tampiltransaksi() {
        ...
        String sql = "SELECT tbl_siswa.Nama_siswa,tbl_transaksi.*,tbl_kelas.Nama_kelas"
                ...
                + " Where Nama_siswa like'%" + tCari.getText() + "%' OR Kode_siswa like'%" + tCari.getText() + "%' "
                + " AND Periode='" + cbperiode.getSelectedItem().toString() + "'";
